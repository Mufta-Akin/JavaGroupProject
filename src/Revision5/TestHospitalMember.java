...
public class TestHospitalMember extends HospitalMemberInfo
{
   ...
   public static void main(String[] args)
   {
      ...
      Nurses cNurse =  new Nurses("Naomi Parker", 25, "Female", "N76", 201);
      ...
      Patients bPatient = new Patients("Lyon Shade", "29", "Y81", 2);

      Patients cPatient = new Patients("Walter Preach", "97 Tree Road", 23, "T20", "2", 28, 2, 2016);
